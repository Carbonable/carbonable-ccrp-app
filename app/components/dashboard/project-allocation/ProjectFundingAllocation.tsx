    ...
    return (
        <>
            {projectFundingAllocation.map((allocation: any, idx: number) => {
                return (
                    <tr key={`projection_${idx}`} className="border-b h-12 last:border-b-0 border-neutral-600 hover:bg-neutral-600 items-center text-neutral-200 whitespace-nowrap group">
                        <td className="px-4 sticky left-0 z-10 bg-neutral-800 group-hover:bg-neutral-600">
