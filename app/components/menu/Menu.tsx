...
export default function Menu({openMenu, setOpenMenu}: {openMenu: boolean, setOpenMenu: (open: boolean) => void}) {
    if (openMenu) {
        return (
            <div className="block w-[300px] z-50 fixed bg-neutral-900/90 left-0 lg:w-[200px] h-[100vh] lg:block lg:fixed lg:bg-neutral-900/80 pt-4 pr4">
    ...
    return (
        <div className="hidden w-0 bg-neutral-900 left-0 lg:w-[200px] h-[100vh] lg:block lg:fixed lg:bg-neutral-900/80 pt-4 pr4">
