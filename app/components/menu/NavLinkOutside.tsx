            ...
            {link.isOpen && <a key={link.label} className="uppercase font-inter text-base" href={link.href} target="_blank" rel="noreferrer">
                <div className="w-full flex justify-start items-center hover:brightness-125">
                    ...
                    <div className="flex justify-start items-center py-2 pl-6 text-neutral-200">
                        <img src={`/assets/images/menu/${link.icon}.svg`}  alt={`${link.icon}_active`} className="w-6 h-6 " />
            ...
            {link.isOpen === false && <div key={link.label} className="uppercase font-inter text-base">
                <div className="w-full flex justify-start items-center">
                    ...
                    <div className="flex justify-start items-center py-2 pl-6 text-neutral-400 cursor-default" onMouseEnter={() => setIsShown(false)} onMouseLeave={() => setIsShown(true)}>
                        <img src={`/assets/images/menu/${link.icon}.svg`}  alt={`${link.icon}_inactive`} className="w-6 h-6 " />
